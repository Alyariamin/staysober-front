...
// Update the date formatting to handle invalid dates
const formattedDate = entry.date ? format(parseISO(entry.date), 'MMMM d, yyyy') : 'Unknown date';
const formattedTime = entry.date ? format(parseISO(entry.date), 'h:mm a') : 'Unknown time';
  ...
  return (
    ...
    >
      <div className="p-5">
        ...
        <div 
          className={`prose dark:prose-invert max-w-none cursor-pointer ${isExpanded ? '' : 'line-clamp-3'}`}
        ...
        {entry.triggers && (
          <div className="mt-3 pt-3 border-t border-gray-100 dark:border-slate-700">
            <h4 className="text-xs text-gray-500 dark:text-gray-400 mb-1.5">Trigger:</h4>
